...
const Register: NextPage = () => {
  ...
  const registerHandler = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const response = await fetch(
      `${process.env.API_ENDPOINT}/api/v1/register`,
      {
        method: "POST",
        mode: "cors",
        cache: "no-cache",
            ...
            <div className="flex flex-col w-full justify-center items-center">
              ...
              <form action="submit" onSubmit={registerHandler} className="mb-4">
                <div className="flex flex-col text-sm font-semibold">
                  ...
                  <label htmlFor="registerToken" className="py-2">
                    Register Token
                  </label>
                  <input
                    className="text-black pl-2"
                  ...
                  <Link href="/login">
                    <a className="text-center pt-4 text-blue-500 hover:text-blue-400 cursor-pointer">
                      Back to Login.
                    </a>
                  </Link>
                </div>
