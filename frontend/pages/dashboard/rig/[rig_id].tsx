...
const Rigs: NextPage<Params> = ({ data }) => {
  ...
  let amdIndex: number = -1,
    nvidiaIndex: number = -1;
      ...
      {isAuth ? (
        <>
          ...
          <div className="flex flex-col justify-center items-center h-full w-full">
              ...
              >
                <div className="flex flex-col font-semibold px-8 py-4">
                  <div className="flex flex-row">
                    ...
                    <p className={`${!showKey ? "tracking-tight" : ""}`}>
                      :{" "}
                      {showKey
                        ? data.rig_id
                        : "∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗∗"}
            ...
            {showOverclockModal ? (
              <OverclockModal
                setShowModal={setShowOverclockModal}
                gpu={gpu}
                overclockSuccessHandler={(res: any, idx: number) => {
